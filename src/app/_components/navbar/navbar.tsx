...
import imageLogo from "../../../images/freshcart.svg";
    ...
    <>
      <nav className="bg-gray-400 py-2 ">
        <div className="max-w-screen-xl flex flex-wrap md:flex-nowrap items-center justify-between mx-auto p-4">
          ...
          >
            <Image width={170} height={80} src={imageLogo} alt="logo" />
          </a>
          <button
          ...
          <div
            id="navbar-default"
            className={`${!isOpen ? "hidden" : ""} w-full md:flex justify-evenly items-center`}
          >
              ...
              {status === "authenticated" ? (
                <>
                  ...
                  <li className="relative">
                      <span className="bg-green-500 text-white p-1 rounded-full absolute -top-[23px] start-3">{cartData?.numOfCartItems}</span>
                  <a href={'/cart'}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
