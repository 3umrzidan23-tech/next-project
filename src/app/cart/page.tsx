...
import { DeleteCartItem } from "@/servises/cart/delet-cart-item";
import { CartResponse } from "@/types/cart-response";
import { useMutation, useQuery } from "@tanstack/react-query";
import React from "react";
import toast from "react-hot-toast";
import { useQueryClient } from "@tanstack/react-query";
import { UpdayeCartItem } from "@/servises/cart/update-cart";
...
export default function Cart() {
  ...
  //delete
  const { mutate: delCartItem, data } = useMutation({
      ...
      <div className="flex gap-5">
        <div className="w-3/4">
          <div className="relative overflow-x-auto bg-neutral-primary-soft shadow-xs rounded-base border border-default">
                        ...
                        <form className="max-w-xs mx-auto">
                          ...
                          <div className="relative flex items-center">
                            ...
                            <span
                              id="counter-input-1"
                              data-input-counter=""
                              className="shrink-0 mx-3 text-heading border-0 bg-transparent text-sm font-normal focus:outline-none focus:ring-0 max-w-[2.5rem] text-center"
                              defaultValue={12}
                            >
                              {prod.count}
                            </span>
            ...
            <button onClick={() => removeCart()} className="my-4">
              Clear Cart
            </button>
          </div>
        </div>
...
// };
// كتبتها على ال middleeware وظهر ايرور